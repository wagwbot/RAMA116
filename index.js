...
*/
const XPTN = 'RAMA; // JANGAN DI UBAH NNTI EROR
const instagram = 'riska_gaming._'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+62895355566000; // JANGAN DI UBAH NANTI EROR
const aktif = 'Sesuai Selera'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/ITbbpsZNWrzJ5RMtE37TiL'; // DI GANTI AUTO EROR
const youtube = 'https://chat.whatsapp.com/ITbbpsZNWrzJ5RMtE37TiL'; // DI GANTI AUTO EROR
//
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @riska_gaming._`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @riska_gaming`)
})
